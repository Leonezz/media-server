    ...
    W: io::Write,
{
    ...
    fn write_stream_begin(&mut self, stream_id: u32) -> ChunkMessageResult<()> {
        self.inner
    ...
    fn write_stream_eof(&mut self, stream_id: u32) -> ChunkMessageResult<()> {
        self.inner
    ...
    fn write_stream_dry(&mut self, stream_id: u32) -> ChunkMessageResult<()> {
        self.inner
    ...
    fn write_stream_ids_recorded(&mut self, stream_id: u32) -> ChunkMessageResult<()> {
        self.inner
    ...
    fn write_ping_request(&mut self, timestamp: u32) -> ChunkMessageResult<()> {
        self.inner
    ...
    fn write_ping_response(&mut self, timestamp: u32) -> ChunkMessageResult<()> {
        self.inner
